...
This is a personal study project. I implemented this R package to
understand the methodology in the paper below by translating it into
working code. It is not intended for publication or distribution.
...
All statistical methodology, terminology, and algorithms belong to the
original authors. This code is an independent reimplementation for
learning purposes only.

------------------------------------------------------------------------

The package answers a question that `bayesplot` cannot: **is the plot
type I chose faithful to my data?** A KDE overlay, a histogram, and a
quantile dot plot all represent the same data differently — `ppcviz`
quantifies how much each representation distorts the distribution, using
the data’s own PIT values as a probe.
...
| **Visualization PIT values**  | —                           | [`pit_kde()`](https://utkarshpawade.github.io/ppcviz/reference/pit_kde.md), [`pit_histogram()`](https://utkarshpawade.github.io/ppcviz/reference/pit_histogram.md), [`pit_qdotplot()`](https://utkarshpawade.github.io/ppcviz/reference/pit_qdotplot.md)                                                               |
| **Viz. goodness-of-fit test** | —                           | [`viz_gof()`](https://utkarshpawade.github.io/ppcviz/reference/viz_gof.md), [`check_viz()`](https://utkarshpawade.github.io/ppcviz/reference/check_viz.md)                                                                                                                                                             |
| **Data property detection**   | —                           | [`detect_discrete()`](https://utkarshpawade.github.io/ppcviz/reference/detect_discrete.md), [`detect_bounds()`](https://utkarshpawade.github.io/ppcviz/reference/detect_bounds.md)                                                                                                                                     |
| **PAVA calibration plots**    | —                           | [`ppc_calibration()`](https://utkarshpawade.github.io/ppcviz/reference/ppc_calibration.md), [`ppc_calibration_residual()`](https://utkarshpawade.github.io/ppcviz/reference/ppc_calibration_residual.md), [`ppc_calibration_discrete()`](https://utkarshpawade.github.io/ppcviz/reference/ppc_calibration_discrete.md) |
| **Automatic recommender**     | —                           | [`recommend_ppc()`](https://utkarshpawade.github.io/ppcviz/reference/recommend_ppc.md)                                                                                                                                                                                                                                 |
...
![viz_gof passes](reference/figures/viz_gof_pass.png)

viz_gof passes

KDE on Beta(2,5) data **without** boundary correction — **fails**:

![viz_gof fails](reference/figures/viz_gof_fail.png)

viz_gof fails

Same Beta(2,5) data **with** `bounds = c(0, 1)` — **passes** after
correction:

![viz_gof bounds corrected](reference/figures/viz_gof_bounds.png)

viz_gof bounds corrected

### Calibration plots

Binary PAVA calibration (`ppc_calibration`):

![ppc_calibration](reference/figures/ppc_calibration.png)

ppc_calibration

Calibration residual plot (`ppc_calibration_residual`):

![ppc_calibration_residual](reference/figures/ppc_calibration_residual.png)

ppc_calibration_residual

Discrete / ordinal calibration (`ppc_calibration_discrete`):

![ppc_calibration_discrete](reference/figures/ppc_calibration_discrete.png)
